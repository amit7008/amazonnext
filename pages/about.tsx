        ...
        <>
            ...
            <div className="mainContent">
                <section>
                    <div className="container">
                        <div className="row align-items-center">
                            ...
                            <div className="col-md-5"><Image className="img-fluid" src='/img/aboutimg1.png' width={830} height={750} /></div>
                        </div>
                    </div>
                </section>
                <section className="aboutTwo bgGrey">
                    <div className="container">
                        <div className="row align-items-center">
                            <div className="col-md-5"><Image className="img-fluid" src='/img/3-5.png' width={562} height={583} /></div>
